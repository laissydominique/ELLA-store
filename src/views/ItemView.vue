   ...
   <div class="content-clothing">
      <div class="container-clothing">
        <div class="clothing-image">
          <img :src="useItems.item.image" alt="" width="550px" height="650px" />
        </div class="clothing-data">
        <div class="details-items"> 
        <div class="clothing-title-item">
          <p translate="yes">{{ useItems.item.title }}</p>
        </div>
        <div class="data-price-item"> 
        <div class="clothing-price">
          <p>R$ {{ useItems.item.price }}</p>
        </div>
          <div class="cart">
